...
GoalkeeperController::GoalkeeperController(ControllableObject &obj,
...
GoalkeeperControllerFactory::GoalkeeperControllerFactory(TeamCollection &game,
                                                         Team &team,
                                                         float speed,
                                                         float kickStrength,
                                                         float range)
...
GoalkeeperControllerFactory::create(ControllableObject &obj,
                                    KickHandler *kick) {
  std::unique_ptr<GoalkeeperController> ctrl =
      std::make_unique<GoalkeeperController>(obj, this->gameObjects, this->team,
