...
HalfdefenderController::HalfdefenderController(ControllableObject &obj,
...
HalfdefenderControllerFactory::HalfdefenderControllerFactory(
    TeamCollection &game, Team &team, float speed, float kickStrength,
    float range)
    : PlayerControllerFactory::PlayerControllerFactory(game, team, speed,
                                                       kickStrength),
      range(range) {}

std::unique_ptr<ObjectController>
HalfdefenderControllerFactory::create(ControllableObject &obj,
                                      KickHandler *kick) {
  std::unique_ptr<HalfdefenderController> ctrl =
      std::make_unique<HalfdefenderController>(obj, this->gameObjects,
                                               this->team, this->speed,
                                               this->kickStrength, this->range);
