...
BallController::BallController(ControllableObject &obj, float slowDown,
                               Rect &rect)
    : ObjectController::ObjectController(obj), field(rect), speed(0.0f),
      slowDown(slowDown) {}
...
float BallController::getSpeed() const { return this->speed; }

void BallController::setSpeed(float speed) { this->speed = speed; }
...
BallControllerFactory::BallControllerFactory(float slowDown, Rect rect)
    : field(rect), slowDown(slowDown) {}

std::unique_ptr<ObjectController>
BallControllerFactory::create(ControllableObject &obj) {
...
float Ball::getSpeed() { return this->getBallController().getSpeed(); }

void Ball::setSpeed(float speed) { this->getBallController().setSpeed(speed); }
}