...
RefereeControllerFactory::RefereeControllerFactory(
    GameObjectCollection &gameObjects, float speed)
...
void Referee::reset(PassiveObject &ball) { this->getBehavior().reset(ball); }

RefereeController::RefereeController(ControllableObject &obj,
                                     GameObjectCollection &game, float speed)
