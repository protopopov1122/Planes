...
namespace Football {
	...
	class PlayerControllerFactory {
		public:
			...
			virtual std::unique_ptr<ObjectController> create(ControllableObject &, KickHandler *) = 0;
		protected:
	...
	class PlayerController : public BehaviorController {
		public:
			PlayerController(ControllableObject &, TeamCollection &, Team &, float, float);
			Team &getTeam();
	...
	class AttackerController : public PlayerController {
		public:
			AttackerController(ControllableObject &, TeamCollection &, Team &, float, float);
		protected:
	...
	class AttackerControllerFactory : public PlayerControllerFactory {
		public:
			...
			std::unique_ptr<ObjectController> create(ControllableObject &, KickHandler *) override;
	};

	class DefenderController : public PlayerController {
		public:
			DefenderController(ControllableObject &, TeamCollection &, Team &, float, float);
		protected:
			virtual void play(PassiveObject &, float);
	};
	...
	class HalfdefenderController : public PlayerController {
		public:
			HalfdefenderController(ControllableObject &, TeamCollection &, Team &, float, float, float);
		protected:
			virtual void play(PassiveObject &, float);
		private:
			float range;
	...
	class GoalkeeperController : public PlayerController {
		public:
			GoalkeeperController(ControllableObject &, TeamCollection &, Team &, float, float, float);
		protected:
			virtual void play(PassiveObject &, float);
		private:
			float range;
